...
| S-05 | spaced-repetition-session        | użytkownik może przejść sesję należnych powtórek, ocenić fiszki i zachować postęp                          | F-01, S-02    | US-01, FR-011, FR-012                 | in-progress |
...
- **Blockers:** —
- **Unknowns:** —
- **Risk:** Przepływ korzysta z bezpłatnych modeli OpenRouter bez aplikacyjnego limitowania żądań; zaakceptowane ryzyko dotyczy dostępności i wyczerpania limitu dostawcy.
- **Status:** done
...
1. **Jak użytkownik ocenia znajomość fiszki podczas sesji?** — Owner: user. Block: S-05.
2. **Jaki gotowy algorytm spaced repetition wyznacza kolejny termin i jak interpretuje ocenę?** — Owner: user. Block: S-05.
3. **Jak reguły generowania i powtórek powinny zmienić się przy wzroście skali do około 10 000 użytkowników?** — Owner: user. Block: —.
4. **Jakie są oczekiwane wolumen danych i szczytowa liczba żądań po uruchomieniu?** — Owner: user. Block: —.
