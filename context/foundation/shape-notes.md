...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "primary persona"
      decision: "programmer"
    - topic: "pain category"
      decision: "friction in creating flashcards"
    - topic: "product insight"
      decision: "few tools currently apply AI directly to this flashcard-creation workflow"
    - topic: "authentication"
      decision: "email and password"
    - topic: "role model"
      decision: "one user role; each user accesses only their own flashcards"
    - topic: "MVP flow"
      decision: "login, paste source text, generate flashcards, review/edit/accept, then spaced-repetition review"
    - topic: "MVP timeline"
      decision: "3 weeks of after-hours work"
    - topic: "source text guidance"
      decision: "show a short instruction explaining what source text produces good results"
    - topic: "product type"
      decision: "desktop web application"
    - topic: "target user scale"
      decision: "up to 100 users"
    - topic: "hard deadline"
      decision: "none"
  frs_drafted: 12
